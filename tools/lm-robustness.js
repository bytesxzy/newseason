...
async function main() {
  ...
  /* A repeat keeps its facts but is not word-for-word the same answer. */
  check("repeated question keeps its facts, worded afresh",
        /Paris/.test(a1.text) && /Paris/.test(a2.text) && a1.text !== a2.text, a1.text.slice(0, 30) + " / " + a2.text.slice(0, 30));
